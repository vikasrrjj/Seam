...
func NewConsumer(brokers []string, topic string, startOffset int64, decode DecodeFunc) (*Consumer, error) {
	opts := []kgo.Opt{
	...
	return &Consumer{client: client, topic: topic, decode: decode}, nil
}
